    ...
    $('.translate-link').click(function (e) {
        ...
        widget.getPosition(function (pos) {
            if ($(this).attr('data-linkto') == $(this).attr('data-default')) {
                re = /&translate=(.*)/g;
                location.href = location.href.replace(re, '') + '&time=' + Math.floor(pos / 1000) + toggleAvailability  + urlIndexPiece;
            } else {
                re = /&time=(.*)/g;
                location.href = location.href.replace(re, '') + '&translate=1&time=' + Math.floor(pos / 1000) + toggleAvailability + urlIndexPiece;
            }
        });
    });
